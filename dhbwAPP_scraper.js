...
if (sessionCourse.startsWith("T")) {
    Kurs = "FN-" + sessionCourse;
}else if (sessionCourse.startsWith("W")) {
    Kurs = "RV-" + sessionCourse;
}
...
import fs from "fs";
fs.writeFileSync(`./data/timetables/${Kurs}.json`, JSON.stringify(scrapingResult, null, 2), "utf-8");